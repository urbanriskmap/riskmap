define('app',['exports'], function (exports) {
  ...
  var App = exports.App = function () {
    ...
    App.prototype.configureRouter = function configureRouter(config, router) {
      ...
      config.map([{ route: 'map', moduleId: 'routes/map/map' }, { route: 'map/jakarta', moduleId: 'routes/map/map' }, { route: 'map/surabaya', moduleId: 'routes/map/map' }, { route: 'map/bandung', moduleId: 'routes/map/map' }, { route: 'cards/:id', moduleId: 'routes/cards/cards' }]);
      this.router = router;
    };
