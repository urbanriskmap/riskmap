export class LocaleId {
  constructor() {
    this.translation_strings = {
      ...
      "report_info": {
        "share_msg": "Laporan%20banjir%20pada%20riskmap%2Eid",
        "water_depth": "Tinggi",
        "source": "Sumber"
      },
      "flood_info": {
      ...
      "report_content": {
        "twitter": {
          ...
          "steps": [
            "Tweet #banjir ke @riskmap.",
            "Buka linknya, dan ikuti panduan untuk menginput lokasi, foto, dan deskripsi.",
            "Anda dapat melihat laporan Anda di peta lewat link balasan. Cek Riskmap.in untuk info banjir terkini."
          ]
        },
        "telegram": {
        ...
        "otherapps": {
          ...
          "steps": [
            ...
            "Laporan Anda sudah tampil di peta. Cek Riskmap.in untuk info banjir terkini."
          ],
      ...
      "info_content": {
        "intro": "Riskmap.in memanfaatkan kekuatan media sosial untuk mengumpulkan, menyortir, dan menampilkan informasi banjir secara real-time.",
        "p1": "Riskmap.in merupakan sebuah proyek yang diinisiasi oleh Humanitarian Infrastructures Group di MIT yang bertujuan untuk mengembangkan CogniCity Open Source Software (CogniCity OSS) sebagai sebuah platform gratis dan terbuka untuk manajemen kebencanaan di kota-kota besar di Asia Selatan dan Tenggara.",
        ...
        "p3": "Riskmap.in mengumpulkan, menyortir, dan “memvisualisasikan” data menggunakan CogniCity Open Source Software - sebuah platform untuk manajemen kebencanaan - untuk mengubah kicauan di media sosial dan digital menjadi informasi penting bagi warga, komunitas, dan instansi pemerintah.",
        "partners": {
      ...
      "card_hints":{
        ...
        "agreement_title": "Kesepakatan Kontribusi Riskmap.in",
        ...
        "redirect": "Mengalihkan ke Riskmap.in",
        "next": "LANJUTKAN",
        "previous": "KEMBALI",
