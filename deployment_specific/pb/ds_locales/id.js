const id = {
  ...
  'prep_menu': {
    'btn_names': {
      'drain': 'saluran air mampet',
      'desilting': 'pengerukan',
      'canalrepair': 'perbaikan kanal',
      'treeclearing': 'pohon tumbang'
    }
  },
  'web_menu': {
    'tab_names': {
  ...
  'report_content': {
    ...
    'facebook': {
      'title': 'Laporan lewat Facebook messenger',
      'steps': [
        'Chat ke PetaBencana.id Bot lewat Facebook messenger',
        'Klik pada tombol memulai dan ikuti instruksi untuk input lokasi banjir, mengunggah foto, dan deskripsi.',
        'Anda bisa melihat laporan melalui link yang tertera. Cek PetaBencana.id untuk mengetahui info banjir terupdate.'
      ]
    },
    'otherapps': {
  ...
  'info_content': {
    ...
    'USAID': 'Situs web ini dapat terselenggara dengan dukungan dari Amerika melalui USAID (U.S. Agency for International Development). Situs ini bukan merupakan situs resmi USAID atau Pemerintah Amerika Serikat. Konten situs ini seluruhnya merupakan tanggung jawab dari para pencipta dan belum tentu merefleksikan pandangan dari USAID dan Pemerintah Amerika Serikat.'
  },
  'legend': {
    'title': 'Legenda',
